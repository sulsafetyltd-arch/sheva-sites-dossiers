-- Add infrastructure sites as a third safety audit report domain.
...
alter table public.safety_audit_reports
  ...
  check (report_type in ('workplace', 'construction', 'infrastructure'));
...
begin
  ...
  if p_report_type not in ('workplace', 'construction', 'infrastructure') then
