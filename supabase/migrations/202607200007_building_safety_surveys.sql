-- Annual building safety survey report category.
...
alter table public.safety_audit_reports
  ...
  check (report_type in ('workplace', 'construction', 'infrastructure', 'railway', 'building_survey'));
...
begin
  ...
  if p_report_type not in ('workplace', 'construction', 'infrastructure', 'railway', 'building_survey') then
