const faqs = [
  ...
  },
  {
    ...
    a: 'בתיק העסקה לחצו «הפק סט מסמכים». המערכת ממלאת 38 מסמכים — הסכם ושטר מכר, ייפויי כוח (קונה/מוכר/נוטריון/בנק), הערות אזהרה, מס שבח ורכישה, נאמנות, תנאים מתלים, סילוק משכנתא, תצהירים, ועד בית, יורשים, קומבינציה ועוד — לפי שמות הצדדים. אחר כך אפשר להדפיס או לשמור PDF.',
  },
];
