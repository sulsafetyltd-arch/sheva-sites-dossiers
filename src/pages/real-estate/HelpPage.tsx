const faqs = [
  ...
  },
  {
    ...
    a: 'בתיק העסקה לחצו «הפק סט מסמכים». המערכת ממלאת הסכם מכר, שטר מכר, ייפויי כוח, בקשות הערת אזהרה, הצהרת טופס 7000 ועוד — לפי שמות הצדדים, ת.ז., גוש/חלקה והתמורה. אחר כך אפשר להדפיס או לשמור PDF.',
  },
];
